          ...
          <div className="mx-auto max-w-7xl">
            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
              <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                <div>
                  <h1 className="mt-4 text-2xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-3xl sm:leading-none lg:mt-6 lg:text-4xl xl:text-5xl">
                    <span className="md:block">Empower Your Finances:</span>{' '}
                    <span className="text-indigo-400 md:block"> Seamlessly Lend and Borrow with ZashPay</span>
                  </h1>
